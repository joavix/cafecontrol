            ...
            <article class="app_launch_item">
                <p class="desc app_invoice_link transition">
                    <a title="<?= $invoice->description; ?>"
                       href="<?= url("/app/fatura/{$invoice->id}"); ?>"><?= str_limit_words(
                            $invoice->description,
                            3,
                    ...
                    elseif ($invoice->repeat_when == 'enrollment'): ?>
                        <span class="app_invoice_link">
                            <a href="<?= url("/app/fatura/{$invoice->invoice_of}"); ?>"
                               title="Controlar Parcelamento"><?= str_pad(
                                    $invoice->enrollment_of,
                                    2,
                                    0,
                                    0
                                ); ?> de <?= str_pad($invoice->enrollments, 2, 0, 0); ?></a>
                        </span>
                    <?php
                    else: ?>
                ...
                <p class="price">
                    ...
                    <?php
                    if ($invoice->status == 'unpaid'): $unpaid += $invoice->value; ?>
