...
class Pay extends Controller
{
    ...
    public function create(array $data): void
    {
        ...
        $checkSubscribe = (new AppSubscription())->findById("user_id = :user AND status != :status",
        ...
        $this->message->success("Bem-vindo ao {$plan->name} {$user->first_name}. Sua assinatura está ativa e você já pode controlar. Confira os detalhes...")->flash();
    ...
    public function update(array $data): void
    {
        ...
        if ($subscribe->status == "past_due") {
            ...
            if ($transaction) {
                ...
                $subscribe->next_due = date("Y-m-d", strtotime($subscribe->next_due . "+{$subscribe->period}"));
                $subscribe->last_change = date("Y-m-d");
                $subscribe->save();
